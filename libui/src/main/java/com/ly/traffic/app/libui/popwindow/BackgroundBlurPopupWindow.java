...
/**
 * 扩展popupWindow可以设置背景的指定部分变色,用法如下
 * ------------------------------------------------------
 * popWindow = BackgroundBlurPopupWindow(
 * popBinding.root,
 ...
 * true
 * )
 * popWindow.setBlurRadius(BackgroundBlurPopupWindow.DEFAULT_BLUR_RADIUS)
 * popWindow.setDownScaleFactor(BackgroundBlurPopupWindow.DEFAULT_BLUR_DOWN_SCALE_FACTOR)
 * popWindow.setDarkColor(Color.parseColor("#80000000"))
 * popWindow.resetDarkPosition()
 * <p>
 * ------------------------------------------------------
 * popWindow.darkBelow(view)
 * popWindow.showAsDropDown(view, view?.right?.div(2) ?: 0, 0)
 * -----------------------------------------------------
 *
 * @author BakerJ
