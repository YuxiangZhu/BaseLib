...
import com.ly.traffic.app.libnet.config.HttpLogInterceptor
import okhttp3.*
...
object HttpApi {
    ...
    private val okClient = OkHttpClient.Builder()
        ...
        .addNetworkInterceptor(HttpLogInterceptor())//添加网络拦截器，可以对okhttp的网络请求做拦截处理，不同于应用拦截器，这里能感知所有网络状态，比如重定向。
        .build()
